...
- `papers/technical-overview.md`  
  canonical high-level overview of important technical details, this document is only maintained manually and must never be changed
